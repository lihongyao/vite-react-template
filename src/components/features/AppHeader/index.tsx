...
export default function AppHeader({ title, description }: { title: string; description: string }) {
  return (
    <>
      <header className="app-header sticky top-0 z-10 w-full border-b border-[#e8e8e8] bg-white/95 pt-[env(safe-area-inset-top)] backdrop-blur-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex min-w-0 flex-1 items-center gap-3">
              <div className="min-w-0">
                ...
                <p className="mt-0.5 truncate text-xs leading-[18px] text-[#737373]">
                  {description}
                </p>
              </div>
            </div>
      ...
      <div className="app-header-lock-spacer" aria-hidden="true" />
    </>
  );
}
